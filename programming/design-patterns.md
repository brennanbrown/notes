...
- There are two important aspects to the decorator pattern, there are the _components_, which are the beverages in this example and the _decorators_, which are the condiments in this example.
